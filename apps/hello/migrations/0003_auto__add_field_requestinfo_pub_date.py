...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequestInfo.pub_date'
        db.add_column(u'hello_requestinfo', 'pub_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 22, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequestInfo.pub_date'
        db.delete_column(u'hello_requestinfo', 'pub_date')
    ...
    models = {
        ...
        u'hello.requestinfo': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 22, 0, 0)'})
        },
        u'hello.userprofile': {
